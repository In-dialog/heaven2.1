...
public class PathFinding : MonoBehaviour
{
    ...
    public static float pastWaight = 0;
    Vector2 Vector;
    ...
    void Start()
    {
        ...
        //for (int i = 0; i < 30; i++)
        //{
        //    satelite.Add(new Vector3(UnityEngine.Random.Range(-500, 500), UnityEngine.Random.Range(-0.1f, 0.1f), UnityEngine.Random.Range(-500, 500)));
    ...
    void Update()
    {
        Debug.Log(StateOfMachine.Instance.SetSate);
